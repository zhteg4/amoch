...
{
  "$end", "error", "$undefined", "TOK_LBRACKET", "TOK_RBRACKET",
  "TOK_COMMA", "TOK_LBRACE", "TOK_RBRACE", "TOK_STR", "TOK_QSTR",
  "$accept", "input", "keys", "items", "list", "keyval", "keyvalbr",
  "endbr", YY_NULLPTR
};
#endif
...
{
       0,    14,     0,     0,     2,     4,     5,     6,     0,    10,
      11,    12,     1,     3,     7,     0,    13,     9,     0,     8
};
...
{
       0,     7,     8,    11,    12,    15,    16,    17,     3,     8,
       9,    14,     0,    12,     8,    13,     6,     4,     5,     8
};
